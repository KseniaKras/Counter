import {AppRootStateType} from "../store";
    ...
    export const selectError = (store: AppRootStateType): boolean =>  store.counter.error
    export const selectCounterSettings = (store: AppRootStateType): boolean =>  store.counter.counterSettings
